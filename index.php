...
<main class="container">
    <section>
        ...
        <h2>Web Developer</h2>
        <p>
            I'm a passionate web developer with a strong focus on backend development. <br>
            While I have a deep love for building the underlying structure of web applications, I also enjoy
            exploring
            the world of frontend development and creating visually appealing user interfaces.<br>
    ...
    <section class="contact">
        ...
        <ul>
            <li>
                ...
                <a class="contrast" target="_blank" href="https://www.linkedin.com/in/mohsen-azarmanesh/">LinkedIn</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="currentColor"
                ...
                <a class="contrast" target="_blank" href="https://x.com/SobhanPyro">X</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="currentColor"
                ...
                <a class="contrast" target="_blank" href="https://t.me/PyroVetis">Telegram</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="currentColor"
        ...
        <ul>
            <li>
                ...
                <a class="contrast" target="_blank" href="mailto:im@mhsn.ir">Business Email</a>
            </li>
        </ul>
        <ul>
            ...
            <li>
                ...
                <a class="contrast" target="_blank" href="https://github.com/pyrovetis">GitHub</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="currentColor"
                ...
                <a class="contrast" target="_blank" href="https://gitlab.com/PyroVetis">GitLab</a>
            </li>
        </ul>
        ...
        <ul>
            <li>
                ...
                <a class="contrast" target="_blank" href="https://myanimelist.net/profile/pyrovetis">MyAnimeList</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <g fill="currentColor">
                ...
                <a class="contrast" target="_blank" href="https://steamcommunity.com/id/PyroVetis/">Steam</a>
            </li>
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="currentColor"
                ...
                <a class="contrast" target="_blank" href="https://goodreads.com/pyrovetis">Goodreads</a>
            </li>
        </ul>
    </section>
    <section class="about">
        ...
        <p>
            <a href="Mohsen-Azarmanesh.pdf">Download my CV</a> | <a href="/projects">View my projects</a>
        </p>
    </section>
</main>
