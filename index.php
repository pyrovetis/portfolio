...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Passionate backend developer with a strong interest in frontend development. I love building robust systems and creating engaging user experiences. Always eager to learn new technologies."
    />
  ...
  <body>
    <main class="container">
      <section>
        <h1>Mohsen Azarmanesh</h1>
        <h2>Web Developer</h2>
        <p>
          I'm a passionate web developer with a strong focus on backend
          development. <br />
          While I have a deep love for building the underlying structure of web
          applications, I also enjoy exploring the world of frontend development
          and creating visually appealing user interfaces.<br />
      ...
      <section class="contact">
        ...
        <ul>
          <li>
            ...
            <a class="contrast" target="_blank" href="https://x.com/SobhanPyro"
              >X</a
            >
          </li>
          <li>
            ...
            <a class="contrast" target="_blank" href="https://t.me/PyroVetis"
              >Telegram</a
            >
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a class="contrast" target="_blank" href="mailto:im@mhsn.ir"
              >Business Email</a
            >
          </li>
        </ul>
        <ul>
          <li>
            ...
            <a
              class="contrast"
              target="_blank"
              href="https://github.com/pyrovetis"
              >GitHub</a
            >
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              class="contrast"
              target="_blank"
              href="https://myanimelist.net/profile/pyrovetis"
              >MyAnimeList</a
            >
          </li>
          <li>
            ...
            <a
              class="contrast"
              target="_blank"
              href="https://steamcommunity.com/id/PyroVetis/"
              >Steam</a
            >
          </li>
          <li>
            ...
            <a
              class="contrast"
              target="_blank"
              href="https://goodreads.com/pyrovetis"
              >Goodreads</a
            >
          </li>
        </ul>
      ...
      <section class="about">
        <h2>About Me</h2>
        <p>
          I'm Mohsen Azarmanesh,
          <?php
            // Calculate age using PHP
            $birthDate = '1999-05-23';
            $today = new DateTime();
            $today->setTimezone(new DateTimeZone('Asia/Tehran')); $diff =
          $today->diff(new DateTime($birthDate)); echo $diff->y; ?>, living in
          Tehran, Iran.
        </p>
        <p>
          I primarily speak Farsi, but I am fluent in English. I have a passion
          for technology and enjoy creating things. Additionally, I'm a fan of
          anime, manga, and video games.
        </p>
        <p>
          I graduated from Sama Islamshahr Islamic Azad University in July 2020.
          My coding journey began in 2012 with simple PHP scripts on a free
          hosting and domain platform. Since then, I've expanded my skills to
          include Python and JavaScript.
        </p>
        <p>
          <a href="Mohsen-Azarmanesh.pdf">Download my CV</a> |
